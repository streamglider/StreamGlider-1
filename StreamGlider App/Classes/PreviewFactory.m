...
+ (PreviewViewController*)createPreviewFor:(Frame*)frame {
	
	GenericPreviewViewController *c = [[GenericPreviewViewController alloc] 
									   initWithNibName:@"GenericPreviewViewController" bundle:nil];
	c.frame = frame;
